	...
	<div class="container write-container">
		<div class="card">
			<div class="card-header">
				<h4 class="mb-0">
					<i class="bi bi-pencil-square me-2"></i>자료실 업로드
				</h4>
			</div>
				...
				<form action="/item/createForm" method="post" enctype="multipart/form-data">
					...
					<div class="mb-4">
						<label for="name" class="form-label">상품이름</label> <input type="text"
							...
							placeholder="상품이름을 입력해 주세요" required>
					</div>

					<div class="mb-4">
						<label for="writer" class="form-label">상품가격</label>
						<div class="input-group">
							<span class="input-group-text"><i class="bi bi-person"></i></span>
							<input type="text" class="form-control" id="price" name="price"
								placeholder="상품가격을 입력하세요" required>
						</div>
					</div>

					<div class="mb-4">
						<label for="picture" class="form-label">상품파일</label> <input type="file"
							class="form-control form-control-lg" id="picture" name="picture"
							required>
					</div>
					
					<div class="mb-4">
						<label for="picture" class="form-label">상품이미지설명</label> 
						<textarea type="text"	class="form-control form-control-lg" id="description" name="description"
